...
import { getLocation, parse, print } from 'graphql/language';
...
export function formatWarning(name, loc, queryStr, source = 'query.graphql') {
  const location = queryStr ? getLocation({
    body: queryStr
  }, loc.start) : {
    line: 0,
    column: 0

...
exports.combineContext = combineContext;
exports.getListPageContext = getListPageContext;
exports.getItemContext = getItemContext;
...
function combineContext(route, config) {
...
function getListPageContext(items, pageNumber, routeContext) {
  const {
    route,
    context,
    totalPages
  ...
  if (paginate.firstPage && pageNumber === 1) {
    ...
    currentPath = (0, _takeshapeRouting.formatPath)(paginate.path, {
      num: pageNumber
    }).path;
  }
...
function getItemContext(route, context, {
  current,
  previous,
  next
}) {
